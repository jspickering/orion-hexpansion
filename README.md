...
* 4 inserts (2mm diameter) (AMAZON LINK)
* 4 screws (2mm diameter) (AMAZON LINK)
...
2)  Using a laser cutter, cut the acrylic sheets. The top one should be cut with the design file for the [top layer](), and the bottom one with the design file for the [second layer]().
